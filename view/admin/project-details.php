<?php  
  ...
  include_once "$_SERVER[DOCUMENT_ROOT]/free/controller/admin/project-details.php";
...
<!--Main profile card-->
	...
	<button class="btn btn-warning btn-lg" id="applybtn" name="delete_pro"style=" margin-left: 3in; margin-top: -90px; ">Delete Project</button>
</form>
	        <p></p>
