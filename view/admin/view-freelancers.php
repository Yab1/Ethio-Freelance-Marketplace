<?php
 ...
 include_once "$_SERVER[DOCUMENT_ROOT]/free/controller/admin/freelancers.php";
...
<!--Freelancer Profile Details-->	
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			<div class="panel panel-success">
			  <div class="panel-heading"><h3>All Freelancers</h3></div>
...
if ($resultcheck7 > 0){
	echo '<table  style=" width: 100% ; border: none;">';
		...
		while($row=mysqli_fetch_assoc($result7)){
			...
			echo '
			<form action="view-freelancers.php" method="post">
			<tr >
...
<?php 
if ($page>1) {
	echo "<a href='view-freelancers.php?page=".($page-1)." 'class='btn btn-danger' style='margin-left:10px; margin-top:10px;'>Back</a>" ;
}

for ($i=1; $i < $total_page_free; $i++) 
{ 
   echo "<a href='view-freelancers.php?page=".$i." 'class='btn btn-primary' style='margin-left:10px; margin-top:10px;'>$i</a>" ;
}
if ($i>$page) {
	echo "<a href='view-freelancers.php?page=".($page+1)." 'class='btn btn-danger' style='margin-left:10px; margin-top:10px;'>Next</a>" ;
}
?>
	</div>
<!--End Column 1-->
