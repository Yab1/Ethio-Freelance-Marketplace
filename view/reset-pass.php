...
?>
  ...
  <div class="panel-body">
					<form action="../controller/reset-pass.php" name="chngpwd" method="post" class="form-horizontal" >
						<div class="form-group">
							...
							<div class="col-md-8">
								<div class="input-group">
									...
									<input type="password"  class="form-control1"  name="current" id="email" placeholder="Current Password" required=""><span id="user-result"></span> 
								</div>
							</div>
						</div>
