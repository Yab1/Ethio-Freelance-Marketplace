...
<?php 
if ($page>1) {
	echo "<a href='services.php?page=".($page-1)." 'class='btn btn-danger' style='margin-left:10px; margin-top:10px;'>Back</a>" ;
}

for ($i=1; $i < $total_page_ser; $i++) 
{ 
   echo "<a href='services.php?page=".$i." 'class='btn btn-primary' style='margin-left:10px; margin-top:10px;'>$i</a>" ;
}
if ($i>$page) {
	echo "<a href='services.php?page=".($page+1)." 'class='btn btn-danger' style='margin-left:10px; margin-top:10px;'>Next</a>" ;
}
?>
	</div>
<!--End Column 1-->
