<?php
 ...
 include_once "$_SERVER[DOCUMENT_ROOT]/free/controller/freelancer/projects.php";
...
<html>
<head>
	<title>All Project Offers</title>
  	<meta charset="utf-8">
...
<!--Freelancer Profile Details-->	
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			<div class="panel panel-success">
			  <div class="panel-heading"><h3>All Project Offers </h3></div>
...
<?php 
if ($page>1) {
	echo "<a href='projects.php?page=".($page-1)." 'class='btn btn-danger' style='margin-left:10px; margin-top:10px;'>Back</a>" ;
}

for ($i=1; $i < $total_page_ser; $i++) 
{ 
   echo "<a href='projects.php?page=".$i." 'class='btn btn-primary' style='margin-left:10px; margin-top:10px;'>$i</a>" ;
}
if ($i>$page) {
	echo "<a href='projects.php?page=".($page+1)." 'class='btn btn-danger' style='margin-left:10px; margin-top:10px;'>Next</a>" ;
}
?>
	</div>
<!--End Column 1-->
